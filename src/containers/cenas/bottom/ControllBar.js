...
class HomeBottomView extends Component {
  ...
  getData() {
    ...
    return [
      ...
      return {
        ...
        imageStyle: { tintColor: active ? activeFontColor : fontColor }, // muda a cor da imagem quando o wordmode e escolido
        textStyle: { fontSize: cx(10), color: active ? activeFontColor : fontColor }, // muda a cor do texto quando  o wordmode e escolido
  ...
  render() {
    ...
    return (
      ...
      //  animação de esconder os botões do menu de rodapé
